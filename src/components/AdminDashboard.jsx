...
const RightPanel = ({ colorPalette, showPanel, onClose, onShowAdDetails }) => {
  ...
  const advertisement = {
    ...
    tagline: "YuvaSaathi: Your Gateway to Opportunities",
