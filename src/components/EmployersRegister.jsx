...
const EmployerRegister = () => {
  const containerStyle = {
    ...
    minHeight: "100vh",
    backgroundImage:
      "linear-gradient(rgba(0,0,0,0.65), rgba(0,0,0,0.65)), url('https://images.unsplash.com/photo-1504384308090-c894fdcc538d')",
  ...
  return (
    <div style={containerStyle}>
      <form style={formWrapperStyle} onSubmit={handleSubmit}>
        <h2 style={titleStyle}>Employer Registration</h2>
