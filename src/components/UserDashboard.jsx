...
import {
  ...
  MessageCircle, Volume2, BookOpen, Lightbulb, UserCog, Code, Database, Factory, HeartPulse, HardHat, Handshake, Brain, Book, Award as AwardIcon // Added new icons
} from 'lucide-react';
    ...
    <div style={{ display: 'flex', minHeight: '100vh', flexDirection: window.innerWidth < 768 ? 'column' : 'row', fontFamily: '"Inter", sans-serif' }}>
      ...
      <div style={{ ...sidebarStyle, transform: isMobileMenuOpen ? 'translateX(0)' : (window.innerWidth < 768 ? 'translateX(-100%)' : 'translateX(0)') }}>
        <div style={sidebarHeaderStyle}>
          <div style={logoStyle}>
            <Monitor size={32} /> Yuva Saathi {/* Renamed from Bihar KIOSK */}
          </div>
          {window.innerWidth < 768 && (
            <button
        ...
        <nav>
          <ul style={{ listStyle: 'none', padding: 0 }}>
            ...
            <li
              style={{ ...navItemStyle(showMoreMenu || ['resumeTemplates', 'recommendations', 'profilePerformance', 'mockTests', 'skillDevelopment', 'aiChatbot'].includes(activeSection)), position: 'relative' }}
              onMouseEnter={(e) => Object.assign(e.currentTarget.style, navItemHoverStyle)}
              onMouseLeave={(e) => Object.assign(e.currentTarget.style, navItemStyle(showMoreMenu || ['resumeTemplates', 'recommendations', 'profilePerformance', 'mockTests', 'skillDevelopment', 'aiChatbot'].includes(activeSection)))}
